  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white flex flex-col items-center justify-center py-16 px-4">
      ...
      <div className="relative bg-gradient-to-br from-white to-green-50 border-2 border-green-100 rounded-3xl px-8 py-10 max-w-xl w-full flex flex-col items-center justify-center shadow-xl mb-12">
        ...
        <h1 className="font-bold text-4xl md:text-5xl mt-2 text-green-700 text-center font-sans mb-2">
          {name}
        </h1>
        <div className="w-24 h-1 bg-green-200 mx-auto rounded mb-4"></div>
        <p className="mt-4 text-center lg:text-lg text-green-900 font-sans leading-relaxed">
          {description}
        </p>
      </div>
      ...
      <div class="w-full px-[25vw] mt-[4vw] max-ma-[80px] flex justify-center">
        <div className="flex items-center justify-center max-w-[400px]">
          <img
            className=" aspect-[310/520] rounded-lg"
            src={image}
            alt={name}
          />
        </div>
      ...
      {/* Video Section */}
      <div className="flex flex-col mt-10 md:mt-16 items-center justify-center w-full ">
        <h2 className="text-4xl md:text-5xl mb-4 md:mb-8 md:ml-0 ml-4 mt-4 font-bold text-green-700 font-sans">
          Video ukázka
        </h2>
